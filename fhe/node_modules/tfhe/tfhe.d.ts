...
*/
  static all_disabled(): TfheConfigBuilder;
/**
* @returns {TfheConfigBuilder}
*/
  enable_default_integers(): TfheConfigBuilder;
/**
* @returns {TfheConfigBuilder}
*/
  enable_default_integers_small(): TfheConfigBuilder;
/**
* @param {ShortintParameters} block_parameters
* @returns {TfheConfigBuilder}
*/
  enable_custom_integers(block_parameters: ShortintParameters): TfheConfigBuilder;
/**
* @returns {TfheConfig}
*/
  build(): TfheConfig;
...
export interface InitOutput {
  ...
  readonly fheuint128_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
  ...
  readonly compactfheuint128list_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly fheuint256_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
  ...
  readonly fheuint8_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
  ...
  readonly compactfheuint8list_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly fheuint16_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
  ...
  readonly compactfheuint16list_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly fheuint32_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
  ...
  readonly compactfheuint32list_deserialize: (a: number, b: number, c: number) => void;
  ...
  readonly fheuint64_encrypt_with_compact_public_key: (a: number, b: number, c: number) => void;
