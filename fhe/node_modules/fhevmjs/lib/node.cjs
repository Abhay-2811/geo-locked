...
var bytesToNumber = function (byteArray) {
...
var createInstance = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var chainId, publicKey, keypairs, buff, tfheCompactPublicKey, contractKeypairs, hasKeypair;
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        ...
                        generateToken: function (options) {
                            ...
                            var _a = generateToken({
                                verifyingContract: options.verifyingContract,
                                name: options.name,
                                version: options.version,
                                chainId: chainId,
                                keypair: kp,
                            }), token = _a.token, keypair = _a.keypair;
                            contractKeypairs[options.verifyingContract] = {
                                privateKey: keypair.privateKey,
                                publicKey: keypair.publicKey,
                                signature: null,
                            };
                            return { token: token, publicKey: keypair.publicKey };
                        },
                        setTokenSignature: function (contractAddress, signature) {
                        ...
                        getTokenSignature: function (contractAddress) {
...
var createTfheKeypair = function () {
    ...
    var config = nodeTfhe.TfheConfigBuilder.all_disabled()
